    ...
    <>
      <div className={styles.main}>
        ...
        <div id="faq" className={styles.qnaSection} ref={qnaRef}>
          ...
          <div className={styles.qna}>
            <div className={styles.question}>
              Q. 공연 예매를 하고 송금 QR을 못 찍었어요. 어디서 결제 계좌번호를
              확인할 수 있나요?
            </div>
            <div className={styles.answer}>
              A. 마이페이지 - 공연예매내역에서 송금 계좌번호를 확인하실 수
              있습니다.
            </div>
          </div>
          <div className={styles.qna}>
          ...
          <div className={styles.qna}>
            ...
            <div className={styles.answer}>
              A. (PC 기준) 예매 후 나타나는 팝업창에서 QR을 찍어서 송금을
              진행하면 됩니다. 또는 계좌번호로도 송금하실 수 있습니다.<br></br>
          ...
          <div className={styles.qna}>
            <div className={styles.question}>
              Q. 총동연의 승인을 받은 아기 동아리입니다! 등록을 원하는데
              어떻게하면 되나요?
            </div>
            <div className={styles.answer}>
              A. 모보까 서비스의 동아리 등록 절차는 다음과 같습니다!<br></br>
              <u>moboggahandong@gmail.com</u>으로 동아리를 인증할 수 있는 서류를
              첨부하여 메일을 보내주시면 모보까팀에서 확인 후에 동아리 담당자
              성함, 동아리에서 사용하는 메일 등을 요청드리게 됩니다. 소통 후
              2-3일 이내로 모보까 동아리 관리자 서비스를 이용하실 수 있는 계정을
              알려드릴 예정입니다.
            </div>
          </div>
          <div className={styles.qna}>
            <div className={styles.question}>
              Q. 저희 동아리는 이번 공연 때 얼리버드 행사가 있습니다. 얼리버드 공연을 어떤
              방법으로 생성하면 될까요?
            </div>
            <div className={styles.answer}>
              A. 처음에는 얼리버드 가격으로 공연을 등록해주시고, 얼리버드 예매기간이
              끝나는 날 직접 관리자 마이페이지 - 해당 공연에 들어가셔서 가격을
              수정해주시면 됩니다.
            </div>
          </div>
          <div className={styles.qna}>
            <div className={styles.question}>
              Q. 동아리장 페이지는 폰으로도 접속할 수 있나요?
            </div>
            <div className={styles.answer}>
              A. 아쉽게도 불가능합니다. 현재 학생들이 이용할 수 있는 페이지만 웹, 앱으로 구성되어 있습니다.
              동아리 관리자 페이지는 PC기반 웹을 사용하셔야 합니다.
            </div>
          </div>
          <div className={styles.qna}>
            <div className={styles.question}>
          ...
          <div className={styles.qna}>
            <div className={styles.question}>
              Q. 모보까에 타 공동체(동호회, 학회, 학부 내 행사) 등록이 가능한가요?
            </div>
            <div className={styles.answer}>
        ...
        <div id="contact" className={styles.contactSection} ref={contactRef}>
          ...
          <div className={styles.question}>
            필요한 기능 및 피드백이 있으시면 모보까의 더 나은 발전을 위해 편하게
            아래의 메일 및 전화번호로 문의 부탁드립니다:)
          </div>
